...
TUNNEL_NAME="y-webrtc-signaling"
HTTP_SERVICE_URL="http://localhost:4444"
HOSTNAME="$HOST_DOMAIN"
CREDENTIALS_DIR=~/.cloudflared/y-webrtc
...
echo -e "${YELLOW}Starting Cloudflare Tunnel Setup for Y-WebRTC Signaling Server...${NC}"
...
echo -e "${YELLOW}Your Y-WebRTC signaling server is now accessible at: wss://$HOSTNAME${NC}"
